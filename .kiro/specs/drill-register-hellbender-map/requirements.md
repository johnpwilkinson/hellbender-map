...
Acceptance Criteria:
- 1.1 WHEN the drill implementation lands THE SYSTEM SHALL create `docs/drills/drill-register-hellbender-map.md` containing the literal heading line `# drill-register-hellbender-map`.
